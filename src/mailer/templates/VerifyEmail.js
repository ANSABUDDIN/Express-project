function verifyEmail({ dealerShipName, verificationEmailUrl, email }) {
  const subject = `Let's finish verifying your account on Automaar`;
  const data = `
                                  ...
                                  <div style="color: #e5eaf5; line-height: 140%; text-align: center; word-wrap: break-word">
                                    <p style="font-size: 14px; line-height: 140%">
                                      <span style="font-family: Lato, sans-serif; font-size: 14px; line-height: 19.6px"
                                        ><strong>T H A N K S   F O R   S I G N I N G   U P !</strong></span
                                      >
                                    </p>
                                  </div>
                                </td>
                                      ...
                                      <span style="font-size: 28px; line-height: 39.2px; font-family: Lato, sans-serif"
                                        ><strong
                                          ><span style="line-height: 39.2px; font-size: 28px"
                                            >Verify Your E-mail Address </span
                                          ></strong
                                        >
                                      </span>
                                    </p>
                                  ...
                                  <div style="line-height: 160%; text-align: left; word-wrap: break-word">
                                    <p style="font-size: 14px; line-height: 160%">
                                      <span style="font-size: 18px; line-height: 28.8px; font-family: Lato, sans-serif"
                                        >Hello ${dealerShipName},</span
                                      >
                                    </p>
                                    <p style="font-size: 14px; line-height: 160%"> </p>
                                    <p style="font-size: 14px; line-height: 160%">
                                      <span style="font-size: 18px; line-height: 28.8px; font-family: Lato, sans-serif"
                                        >You are receiving this email because you recently signed up for a new account at
                                        Automaar using the email ${email}.</span
                                      >
                                    </p>
                                    <p style="font-size: 14px; line-height: 160%"> </p>
                                    <p style="font-size: 14px; line-height: 160%">
                                      <span style="font-size: 18px; line-height: 28.8px; font-family: Lato, sans-serif">
                                        You're almost ready to get started. Please click on the button below to verify your
                                        email address! </span
                                      >
                                    </p>
                                  </div>
