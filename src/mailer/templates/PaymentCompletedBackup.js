function paymentConfirmation({
    ...
    const subject = `Booking completed at ${dealerShipName}`;
                                      ...
                                      <tr>
                                        <td style="padding-right: 0px; padding-left: 0px" align="center">
                                          <img
                                            align="center"
                                            border="0"
                                            src="https://assets.unlayer.com/projects/95548/1660488870508-icons8-approval-96.png"
                                            alt="Image"
                                            title="Image"
                                            style="
                                              outline: none;
                                      ...
                                      <p style="font-size: 14px; line-height: 160%; text-align: left">
                                        <span
                                          style="
                                            ...
                                            color: #212121;
                                          "
                                          >Your booking is confirmed at ${dealerShipName}.</span
                                        >
                                      </p>
                                      <p style="font-size: 14px; line-height: 160%; text-align: left"> </p>
                                      <p style="font-size: 14px; line-height: 160%; text-align: left">
                                        <span
                                          style="
                                            ...
                                            color: #212121;
                                          "
                                          >You can contact ${dealerShipName} at ${dealerShipEmail}</span
                                        >
                                      </p>
                                      <p style="font-size: 14px; line-height: 160%; text-align: left"> </p>
                                      <p style="font-size: 14px; line-height: 160%; text-align: left">
                                      ...
                                      <p style="font-size: 14px; line-height: 160%; text-align: left">
                                        <span
                                          style="
                                            ...
                                            color: #212121;
                                          "
                                          >Car Model: ${carModel}<br />Plate Number: ${carPlateNumber}<br />Booking Period:
                                      ...
                                      <p style="font-size: 14px; line-height: 160%; text-align: left">
                                        <span
                                          style="
                                            ...
                                            color: #212121;
                                          "
                                          >Your booking ID is <strong>${bookingID}</strong></span
                                        >
                                      </p>
                                      <p style="font-size: 14px; line-height: 160%; text-align: left"> </p>
                                      <p style="font-size: 14px; line-height: 160%; text-align: left">
                                      ...
                                      <p style="font-size: 14px; line-height: 160%; text-align: left">
                                        <span
                                          style="
                                            ...
                                            color: #212121;
                                          "
                                          >You can open <a href="${CANCEL_URL}">this link</a> to cancel booking directly.</span
                                        >
                                      </p>
                                    </div>
                                  </td>
