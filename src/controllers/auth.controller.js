...
const forgotPassword = catchAsync(async (req, res) => {
  ...
  await emailService.sendResetPasswordEmail(req.body.email, resetPasswordToken.token, resetPasswordToken.name);
...
const verifyEmail = catchAsync(async (req, res) => {
  ...
  await emailService.sendNewUserEmail(config.email.adminEmail, userData);
  res.status(httpStatus.OK).json({ status: 'done' });
});
